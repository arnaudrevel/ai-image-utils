...
* **Description** : Client en ligne de commande hautement optimisé pour évaluer la qualité esthétique d'une image ou d'un dossier complet à l'aide d'un modèle **ViT (Vision Transformer)** de Hugging Face. Il classe les images dans l'un des 6 paliers de qualité.
* **Fonctionnalités** :
